...
def read_file(file_name, charlen=CHAR_LEN, 
              smiles_column="SMILES", remove_salt=True, isomeric_smiles=False, 
              fp_radius = 2, fp_bits=2048, useCount=False, 
              mw_calc=False, step=20, max_weight=500):
    hot_smiles, fp_array, mw = read_file_base(file_name, smiles_column, remove_salt, 
...
def GetHashedMorganFingerprintArray(mol, radian, fp_bits):
